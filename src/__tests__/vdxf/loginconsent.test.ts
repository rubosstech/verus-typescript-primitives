...
describe('Serializes and deserializes signature objects properly', () => {
  ...
  test('attestation request', async () => {
    const req = new LoginConsentRequest({
      system_id: "i5w5MuNik5NtLcYmNzcvaoixooEebB6MGV",
      signing_id: "iB5PRXMHLYcNtM8dfLB6KwfJrHU2mKDYuU",
      signature: {
      ...
      challenge: {
        challenge_id: "iKNufKJdLX3Xg8qFru9AuLBvivAEJ88PW4",
        requested_access: [new RequestedPermission(IDENTITY_VIEW.vdxfid),
          new RequestedPermission( ATTESTATION_READ_REQUEST.vdxfid, {accepted_attestors:["iC9x9VZ2XMop7spFzeXqSKX8WqmrG9cu41"], attestation_keys:["iSSxdyTcCp8VALGBGKy8R7ATYSRuK15NkL","i3jWsqLVnYyJu78E7mw6pbD3TazwZJpuk4","i9MRw6YUhXtP6DT8eufGnB5oRQ34TjDsdb","iJvFSXk2EDeEu9BkJQSwAVeiochF6AYpfF"]})],
        session_id: "iRQZGW36o3RcVR1xyVT1qWdAKdxp3wUyrh",
        redirect_uris: [
          new RedirectUri(
            "https://www.verus.io",
