...
import { Attestation, LoginConsentRequest, LoginConsentResponse, AttestationProof } from "../../vdxf/classes";
...
describe('Serializes and deserializes attestation request', () => {
    test('attestation request with reply', async () => {
        ...
        componentsArray.push({attestationKey: ATTESTATION_IDENTITY_DATA["firstname"].vdxfid, salt: "8e6744dc4f229e543bbd00d65b395829e44c8eb7b358ee3131ca25e6ecc3b210", value: "Chris"})
        componentsArray.push({attestationKey: ATTESTATION_IDENTITY_DATA["lastname"].vdxfid, salt: "7c3920940db4385cd305557a57a8df33346712096e76b58d7c4ace05e17b90a2", value: "Monkins"})
        componentsArray.push({attestationKey: ATTESTATION_IDENTITY_DATA["identity"].vdxfid, salt: "ce662d61a20ae211728cdb1b924628c84edfe0fcbd59a86f56a125ad73689ac1", value: "chad@"})
        componentsArray.push({attestationKey: ATTESTATION_IDENTITY_DATA["attestor"].vdxfid, salt: "9067dc6a9b38dd15f985770bb819eb62de39a5d1f0e12f9a4807f78968794af4", value: "valu attestation@"})
        componentsArray.push({attestationKey: ATTESTATION_IDENTITY_DATA["documenttype"].vdxfid, salt: "338b6ad44179f46fc24f3ed01fd247c9664384a71ba5465aebceece8d7c45a0a", value: "KYC Attestation v1"})
        ...
        const attestationResponse = new Attestation("i5w5MuNik5NtLcYmNzcvaoixooEebB6MGV",{components: componentsArray, signatures: signaturesForAttestation});

        await attestationResponse.createMMR();

        const proofResponseRoot = await attestationResponse.getRoot();

        const proofreply = await attestationResponse.getProof([0]);

        const proofRoot = await proofreply.mmr.getRoot();
        ...
        expect(proofRoot.toString('hex')).toStrictEqual("fa3cf78b174a39ddf7967afbfda54953ed55e44c6731de8796eb37ba77afddf1")
